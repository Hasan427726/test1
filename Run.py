    ...
    try:
        ...
        if token.lower() == 'get' or 'get' in str(token.lower()):
            ...
            try:
                ...
                response2 = requests.get('https://mbasic.facebook.com/photo.php?fbid==757953543&set=a.10156844811553544', headers = {'cookie': cookies}).text # Jangan Di Ganti
                data = {
...
[bold white][[bold green]4[bold white]]. Keluar ([bold red]Exit[bold white])""", width=47, style="bold white"))
    try:
        ...
        print(Panel(f"[bold red] {str(e).title()}!", width=47, style="bold white"));break"bold white"));break